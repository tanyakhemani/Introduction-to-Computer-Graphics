...
const char *WINDOWTITLE = { "OpenGL / GLUT Sample -- Tanya Khemani" };
...
Display( )
{
	...
	RotateY(&Curves[5].p0, 35.0*sin(120 * Time), -1.25, 1.25, -0.25);
	RotateY(&Curves[6].p0, 35.0*sin(120 * Time), -1.25, 1.25, -0.25);
	RotateY(&Curves[5].p3, -35.0*sin(120 * Time), -1.25, 1.25, -0.25);
	RotateY(&Curves[6].p3, -35.0*sin(120 * Time), -1.25, 1.25, -0.25);

    Curves[5].r = rgb[1]; Curves[5].g = rgb[0]; Curves[5].b = rgb[2];
	Curves[6].r = rgb[1]; Curves[6].g = rgb[0]; Curves[6].b = rgb[2];

	//right eye animate

	RotateY(&Curves[7].p0, 35.0*sin(120 * Time), 1.25, 1.25, -0.25);
	RotateY(&Curves[8].p0, 35.0*sin(120 * Time), 1.25, 1.25, -0.25);
	RotateY(&Curves[7].p3, -35.0*sin(120 * Time), 1.25, 1.25, -0.25);
	RotateY(&Curves[8].p3, -35.0*sin(120 * Time), 1.25, 1.25, -0.25);

	Curves[7].r = rgb[1]; Curves[7].g = rgb[0]; Curves[7].b = rgb[2];
	Curves[8].r = rgb[1]; Curves[8].g = rgb[0]; Curves[8].b = rgb[2];
	...
	Curves[9].r = rgb[1]; Curves[9].g = rgb[0]; Curves[9].b = rgb[2];
	Curves[10].r = rgb[1]; Curves[10].g = rgb[0]; Curves[10].b = rgb[2];
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., "Geometric Modeling" );
...
InitGraphics( )
{
	...
	//stationary curve 1: face upper curve
	Curves[0].r = 0.0; Curves[0].g = 0.3; Curves[0].b = 0.2;
	...
	//stationary curve 2: face lower curve
	Curves[1].r = 0.0; Curves[1].g = 0.3; Curves[1].b = 0.2;
	...
	Curves[2].r = 0.0; Curves[2].g = 2.0; Curves[2].b = 4.09;
	...
	Curves[3].r = 0.3; Curves[3].g = 2.2; Curves[3].b = 4.05;
	...
	Curves[4].r = 1.0; Curves[4].g = 0.0; Curves[4].b = 1.0;
	...
	//animated curve 1: left eye upper curve
	...
	//animated curve 2: left eye lower curve
	...
	//animated curve 3: right eye upper curve
	...
	//animated curve 4: right eye lower curve
	...
	//animated curve 5: mouth upper curve
	...
	//animated curve 6: mouth lower curve
